...
// altered. Note that this does not mean that myStr cannot be changed, just that the
// individual characters of a string literal cannot be changed. The only way to change
