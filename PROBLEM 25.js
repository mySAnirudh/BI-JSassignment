...
// Quotes are not the only characters that can be escaped inside a string. There are
...
// \SecondLine
// ThirdLine
// You will need to use escape sequences to insert special characters correctly. You
// will also need to follow the spacing as it looks above, with no spaces between
